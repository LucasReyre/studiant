...
*/
        GCMMessageService gcmMessageService = RestClient.createService(GCMMessageService.class, Constants.REST_API_OVH);
        try {
            Response<Void> response = gcmMessageService.sendNotification(token,body).execute();
