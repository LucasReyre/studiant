...
public class FoldingCellRecyclerViewEtudiantAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView){
            ...
            priceContent = (TextView) itemView.findViewById(R.id.content_price);
            timeContent = (TextView) itemView.findViewById(R.id.content_date);
            dateContent = (TextView) itemView.findViewById(R.id.content_time);
            description = (TextView) itemView.findViewById(R.id.content_description);
